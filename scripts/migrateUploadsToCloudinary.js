...
async function migrateField(Model, fieldName, query = {}) {
  ...
  for (const doc of docs) {
    ...
    const filename = extractFilenameFromUploadsUrl(originalUrl) || `${Model.modelName.toLowerCase()}_${doc._id}`;
  ...
  console.log(`[${Model.modelName}] Migration done for '${fieldName}'. Success: ${successCount}, Fail: ${failCount}.`);
}
